...
import type { Product, Building, Profile, Telplek, TelplekProduct } from "@/lib/types";
...
export default async function ProductenPage() {
  ...
  const [{ data: profile }, { data: products }, { data: buildings }, { data: links }, { data: telplekken }, { data: telplekProducten }] = await Promise.all([
